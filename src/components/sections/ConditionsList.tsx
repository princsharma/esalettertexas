...
const CONDITION_ICONS: Record<string, string> = {
  Anxiety: "/icons/anxity.webp",
  Depression: "/icons/dipresstion.webp",
  PTSD: "/icons/ptsd.webp",
  "Panic Disorder": "/icons/panic disoder.webp",
  "Social Anxiety": "/icons/SOCAIL anxity.webp",
  ADHD: "/icons/ADHD.webp",
};
      ...
      <section id="conditions" className="scroll-mt-20 relative overflow-hidden bg-white section-py">
        ...
        <Container className="relative grid items-center gap-10 lg:grid-cols-2 lg:gap-16 text-neutral-950">
          <div>
              ...
              {TOP_CONDITIONS.map((item) => (
                <li key={item.title}>
                  ...
                  >
                    ...
                    />
                    <span className="flex h-11 w-11 flex-none items-center justify-center rounded-full bg-white ring-1 ring-neutral-200 transition-transform duration-300 group-hover:scale-110">
                      <Image
                        src={CONDITION_ICONS[item.title]}
                        alt=""
                        width={228}
                        height={228}
            ...
            <Link
              href="/#conditions"
              className="group mt-7 inline-flex items-center gap-1.5 text-md font-semibold text-brand-700 transition-colors hover:text-brand-800"
            >
              View all conditions
              <svg
          ...
          <div className="relative mx-auto w-full max-w-md lg:mx-0">
            ...
            <div className="absolute -bottom-6 -left-6 flex items-center gap-3 rounded-card bg-white p-4 shadow-card-hover ring-1 ring-brand-950/5">
              <span className="flex h-11 w-11 flex-none items-center justify-center rounded-full  border-1 bg-white ring-1 ring-neutral-900">
                <Image
                  src="/icons/Confidential evaluation.webp"
                  alt=""
                  width={30}
                  height={30}
                  className=" object-contain"
